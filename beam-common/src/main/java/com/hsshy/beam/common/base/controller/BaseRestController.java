...
public abstract class BaseRestController<Entity extends RestEntity<ID>,ID extends Serializable>
    ...
    public Object list(Entity entity) {

       return R.ok(commonService.list(new QueryWrapper<Entity>()));
    }
