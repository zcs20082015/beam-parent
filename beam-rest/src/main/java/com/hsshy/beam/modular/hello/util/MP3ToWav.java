package com.hsshy.beam.modular.hello.util;
...
public class MP3ToWav {
    ...
    //设置APPID/AK/SK
    public static final String APP_ID = "11703759";
    public static final String API_KEY = "ix0NncDw0cLHYfgynjexta0F";
    public static final String SECRET_KEY = "w1reaEG5T1ofz0cgLok0mOF6EFTYku8g";
    ...
    public static void main(String args[]) {
        String filePath = "d:/tmp/test1.mp3";
